...
-- This enables the simplified UX where auctions progress: active -> pending_sale -> shipping -> complete
...
-- active auctions stay active
-- ended auctions with orders move to appropriate workflow state
-- ended auctions without orders stay as 'pending_sale' (waiting for order creation)
UPDATE auctions 
